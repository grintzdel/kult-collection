    ...
    <header className="sticky top-0 z-40 border-b border-ink/10 bg-ivory text-ink">
      <div className="mx-auto grid h-16 w-full max-w-[1440px] grid-cols-[1fr_auto_1fr] items-center px-6 md:px-10">
        ...
        <div className="flex items-center justify-end gap-7">
          ...
          <LocalizedClientLink
            href="/pro/connexion"
            className="hidden rounded-full border border-green-700 px-4 py-1.5 font-sans text-[11px] font-semibold uppercase tracking-[0.18em] text-green-700 transition-colors hover:bg-green-700 hover:text-white small:inline-flex"
          >
            Espace Pro
          </LocalizedClientLink>
          ...
          <ul className="flex flex-col gap-4">
            ...
            <li>
              <LocalizedClientLink
                href="/pro/connexion"
                onClick={() => setMobileOpen(false)}
                className="font-sans text-[11px] font-semibold uppercase tracking-[0.18em] text-green-700"
              >
                Espace Pro
              </LocalizedClientLink>
            </li>
