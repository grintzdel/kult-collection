    ...
    .fetch<{ products: HttpTypes.StoreProduct[]; count: number }>(
      `/store/products`,
      {
        ...
        query: {
          ...
          region_id: region?.id,
          fields:
            "*variants.calculated_price,+variants.inventory_quantity,*variants.images,*variants.options,+metadata,+tags,+collection_id,*categories,+categories.parent_category_id,+categories.metadata,",
          ...queryParams,
        },
        headers,
        next,
